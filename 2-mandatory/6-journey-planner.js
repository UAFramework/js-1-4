...
*/
function getTransportModes(locationsArray) {
  return locationsArray.slice(1);
}
...
/*
  Implement the function getLocationName that
   ...
   - Returns the name of the location
      e.g: "Tower Bridge"
*/
function getLocationName(locationsArray) {
...
function journeyPlanner(locations, transportMode) {
  ...
  let transportModes = getTransportModes(location);
  let accessibilityTest = isAccessibleByTransportMode(transportModes, transportMode);
  accessibilityTest ? locationNames.push(getLocationName(location)) : false;
}
